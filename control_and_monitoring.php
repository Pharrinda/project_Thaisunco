...
?>
                    ...
                    <div class="row">
                        <!-- <form action="open.php" method="POST">
                            ...
                            <div class="col-md-6 pull-left">
                                <!-- <div id="btn_open">click</div> -->
                                <!-- <input onclick="" type="submit" class="btn btn-success" id="btn_open" value="1" name="open" style="text-align: center;width: 100px;height: 100px; border-radius: 50%; font-size: 22px;">  
                                <p id="demo"></p>
                                
                            </div>
                            <div class="col-md-6 pull-rigth">
                                <input onclick="" type="submit"  class="btn btn-danger" id="btn_close" value="0" name="close" style="text-align: center;width: 100px;height: 100px; border-radius: 50%; margin-left: 80px; font-size: 22px;">

                            </div>  
                        </form> --> 
                        <form method="POST" action="open.php">
                            <div class="col-md-6 pull-left">
                                <button class="btn btn-success" id="btn_open" type="" value="1" name="open" style="text-align: center;width: 100px;height: 100px; border-radius: 50%; font-size: 22px;"> เปิด </button>
                            </div>
                        </form>
                        <form method="POST" action="close.php">
                            <div class="col-md-6 pull-rigth">
                                <button class="btn btn-danger" id="btn_close" type="" value="0" name="close" style="text-align: center;width: 100px;height: 100px; border-radius: 50%; margin-left: 80px; font-size: 22px;"> ปิด </button>
                            </div>  
                        </form>
                        <?php 
                            // $open = $open.value();
    ...
    <!-- Chart Humidity and Temperture -->
        <div role="tabpanel" class="tab-pane" id="history">
            <div id="chartContainer0" style="height: 200px; width: 100%;"></div>
        </div>
        <div role="tabpanel" class="tab-pane" id="history">
